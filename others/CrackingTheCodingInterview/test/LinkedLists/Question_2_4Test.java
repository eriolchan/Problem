...
public class Question_2_4Test {
    ...
    public void testAdd_SameLength() {
        ...
        ListNode actual = Question_2_4.add(n1, n2);
    ...
    public void testAdd_ExtraCounter() {
        ListNode n1 = ListNodeTest.createLinkedList(new int[] { 1 });
    ...
    public void testAdd_OneElement() {
        ListNode n1 = ListNodeTest.createLinkedList(new int[] { 1 });
        ListNode n2 = ListNodeTest.createLinkedList(new int[] { 1 });
        
        ListNode expected = ListNodeTest.createLinkedList(new int[] { 2 });
        ListNode actual = Question_2_4.add(n1, n2);
        ListNodeTest.assertLinkedListEquals(expected, actual);
    }
