namespace Tests
{
    ...
    public class ListNodeTest
    {
        ...
        public void TestAddToTailWithNull()
        {
            ...
            Assert.AreEqual(new ListNode(5), head);
        }
        ...
        public void TestAddToTailWithOneNode()
        {
            ...
            Assert.AreEqual(Helper.CreateLinkedList(new int[] { 1, 5 }), head);
        }
        ...
        public void TestAddToTailWithMultipleNodes()
        {
            ...
            Assert.AreEqual(Helper.CreateLinkedList(new int[] { 1, 2, 3, 5 }), head);
        }
        ...
        public void TestRemoveNodeWithInTheBegin()
        {
            ...
            Assert.AreEqual(Helper.CreateLinkedList(new int[] { 7 }), head);
        }
        ...
        public void TestRemoveNodeWithInTheEnd()
        {
            ...
            Assert.AreEqual(Helper.CreateLinkedList(new int[] { 1, 3 }), head);
        }
        ...
        public void TestRemoveNodeWithInTheMiddle()
        {
            ...
            Assert.AreEqual(Helper.CreateLinkedList(new int[] { 1, 7 }), head);
        }
